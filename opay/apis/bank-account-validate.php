...
// Load private key securely (recommended: from ENV)
$privateKey = <<<EOD
-----BEGIN PRIVATE KEY-----
...
//  Convert to base64 (same as hextob64 in Postman)
$authorization = base64_encode($signature);
$authorization = trim($authorization);

//  Optional reference (you created it in Postman but not used in body)
// Keep if Opay requires later
$reference = "MBET-OPAY-" . round(microtime(true) * 1000);

//  cURL request
$curl = curl_init();

curl_setopt_array($curl, [
    CURLOPT_URL => 'https://liveapi.opaycheckout.com/api/v1/international/payout/bank-account-validate',
