...
$query_ = "UPDATE korapay_withdrawal SET status='CREATED_ON_PRIZMA' WHERE payment_reference='$code'";
$result_ = mysqli_query($con, $query_);
                ...
                <div class="">
                    <div class="su__">
                        <div class="text-center">
                            <img src="../ico_suc.gif" alt="" class="loader_"><br>
                            <small class="bn">Transfer Success!</small>
                            <section class="text-muted" id="tmsg">Awesome! Your withdrawal payment has been initiated successfully.</section>
