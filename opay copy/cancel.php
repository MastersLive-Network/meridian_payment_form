...
<head>
    ...
    <title>OPAY - Canceled Payment</title>
...
<body>
    ...
    <div class="cc__ text-center">
        ...
        <div class="invalid mt-20 p-4" id="invalid">
            <img src="cancelled.png" class="ww" alt="">
            <h1 class="mt-20 p-4 font-bold">Payment Canceled</h1>
            <small class="text-muted">Payment was canceled. Please close this window and reinitiate the payment if this was unintentional.</small>
        </div>
